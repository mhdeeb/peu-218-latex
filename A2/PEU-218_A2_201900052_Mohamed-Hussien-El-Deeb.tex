...
\[
    dS = \left\lVert \vec{r}_\theta \times \vec{r}_x \right\rVert d\theta dx
\]
...
\[
    \vec{r}_x = \left\langle 1, 0, 0\right\rangle, \quad \vec{r}_\theta = 2 \left\langle 0, -\sin(\theta), \cos(\theta)\right\rangle
\]

\[
    \vec{r}_\theta \times \vec{r}_x = 2 \left\langle 0, \cos(\theta), \sin(\theta)\right\rangle
    , \quad \left\lVert \vec{r}_\theta \times \vec{r}_x \right\rVert = 2
\]
